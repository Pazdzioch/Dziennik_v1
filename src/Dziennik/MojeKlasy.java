...
import Dziennik.User.UserBuilder;
    ...
    public class MojeKlasy  {
    	...
    	private void createGui(String personalia, boolean czyUzytkownikMaKlasy) 
    	{
    		...
    		* Ustawienia okna
    		*/   
    		JFrame frame = new JFrame("Dziennik Elektroniczny - Moje klasy");
    		...
    		public void run()
    			{
    				...
    				MojProfil mojprofil = new MojProfil();
    			 	...
    			 	if(TwojeKlasy != null)
    			 	{
    			 		mojprofil.createGui(null, true); 
        				someFunction(TwojeKlasy);
    			 	}
    			 	
       			 	else mojprofil.createGui(null, false);
